    ...
    var tutorialInstructions: [String] {
        ...
        case .shoulder:
            [
                ...
                "Your mission is to lead the rocket to every stars and complete the journey. To see the stars, try to hold a fist.\n\nIf you want to rearrange stars, hold a fist again.",
                "Try to carry the rocket to the stars without moving your legs. Use only your arm's movement.",
                "Good. Now the rocket needs to charge its fuel. Hold still for five seconds.",
